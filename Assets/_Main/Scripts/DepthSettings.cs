...
// </copyright>
//-----------------------------------------------------------------------
// A copy of GoogleARCore.Examples.Common.DepthMenu.cs, but with minor changes
// to fit the use in the AR GIS application
// Neil Justin Romblon, 30/08/2020
...
public class DepthSettings : MonoBehaviour {
	...
	/// <summary>
	/// The Menu Window shows the depth configurations.
	/// Added by Neil Romblon 01/09/2020
	/// </summary>
	[SerializeField] private GameObject m_SettingsMenuWindow = null;
	...
	private void _OnApplyButtonClicked() {
		...
		m_MenuWindow.SetActive(false);
		m_SettingsMenuWindow.SetActive(true);
	}
